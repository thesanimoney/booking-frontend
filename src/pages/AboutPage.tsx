...
function AboutPage() {
    ...
    return <>
        <div className="mx-auto flex flex-col itemsCenter max-w-[100%] md:max-w-[75%] text-center gap-y-5">
            <TypographyH1 text={'About Us'}/>
            <TypographyP text={mission}/>
        </div>
        <div className="mx-auto mt-10 mb-10 md:mb-0 max-w-[100%] md:max-w-[75%]">
            <ImageTextContainer/>
        </div>
    </>
}
